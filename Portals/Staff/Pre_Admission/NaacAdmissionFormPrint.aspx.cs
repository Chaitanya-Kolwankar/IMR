    ...
    public void get_form()
    {
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                table12.WriteLine("<table style='width:100%;border-spacing: 0px;border: 1px solid;'><tbody><tr><td style='height: 87px; width:18%'><img src='https://imr.vivacollege.in/staff_imr/Assets/img/vivalogon.png' style='height:117px;padding:15px' /></td><td style='height: 87px;text-align: center;'><span> VISHNU WAMAN THAKUR CHARITABLE TRUST`S</span><br/><span><b> VIVA INSTITUTE OF MANAGEMENT AND RESEARCH </b></span><br/><span><b> Shirgaon, Virar(East) </b></span><br/><span style = 'padding-left: 30px; font-size: 12px'> (Affliated to University of Mumbai) </span><br/><span style = 'font-size: 10px'> Shirgaon, Veer Sawarkar road, Virar(East) Tal - Vasai, Dist - Thane, Maharashtra.</span></td><td style='width:17%'><img src='" + "data:image/png;base64," + s_img + "' style='height:90px;text-align:center' ></td></tr><tr><td colspan='3' style='border:1.5px solid black;height: 57px;text-align: center;width:100%;font-weight:bold'>ADMISSION FORM FOR " + rowgroup["Group_title"].ToString().Trim() + " " + Session["year"].ToString() + "</td></tr></tbody></table>");
