            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <label for="inputState" class="form-label">To Date</label>
                                        ...
                                        <asp:TextBox ID="txttodate" runat="server"  autocomplete="off"   CssClass="form-control"></asp:TextBox>                                            </div>
                        ...
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="white">
                            <Columns>
