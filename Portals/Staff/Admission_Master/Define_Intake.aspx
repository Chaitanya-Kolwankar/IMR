                            ...
                            <div class="card-body ">
                                ...
                                <div>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GrdIn" runat="server" OnRowDataBound="GrdIn_RowDataBound" AutoGenerateColumns="false" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="White" Style="max-height: 400px;">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Intake" HeaderStyle-CssClass="text-blue">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="chk_IsCurrent" runat="server" MaxLength="4" onkeyPress="return OnlyNum(event)" OnTextChanged="chk_IsCurrent_TextChanged" ItemStyle-CssClass="form-control caps" Text='<%#Eval("intake")%>' oncopy="return false"
