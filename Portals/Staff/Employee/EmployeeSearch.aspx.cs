...
public partial class Portals_Staff_Employee_EmployeeSearch : System.Web.UI.Page
{
    ...
    public void dataload()
    {
        ...
        if (dt.Rows.Count == 0)
        {
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "$.notify('No Employee Available With Given Info', { type: 'danger', animation: true, animationType: 'drop', align: 'center', verticalAlign: 'top', blur: 0.0, delay: 0 });", true);
        }
    }
        ...
        try
        {
            ...
            if (confirmValue.Contains("Yes"))
            {
                if (e.CommandName == "buttonfieldid")
                {
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "$.notify(' Employee Deleted', { type: 'danger', animation: true, animationType: 'drop', align: 'center', verticalAlign: 'top', blur: 0.0, delay: 0 });", true);
            ...
            if (e.CommandName == "Recover")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "$.notify(' Employee Recovered', { type: 'danger', animation: true, animationType: 'drop', align: 'center', verticalAlign: 'top', blur: 0.0, delay: 0 });", true);
                    dataload();
                }
            }
        }
